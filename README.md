...
```bash
$ docker run --rm -v $PWD:/m68k -t hldtux/docker-deb-m68k
```
...
```bash
$ docker run --rm -v $PWD:/m68k -t hldtux/docker-deb-m68k -c "make clean"
```
...
```bash
$ docker run --rm -v $PWD:/m68k -it hldtux/docker-deb-m68k -c bash
```
